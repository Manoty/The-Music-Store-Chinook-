...
if country_revenue and country_revenue > 0:
    summary_lines.append(f"{selected_country} generated {format_currency(country_revenue)} million dollars in total revenue, reflecting a stable and healthy market position within the broader portfolio.")
...
if top_genre_revenue and top_genre_revenue > 0:
    ...
    summary_lines.append(f"{top_genre_name} is the top-performing genre with {format_currency(top_genre_revenue)} million dollars in revenue, signaling concentrated consumer demand and a strong opportunity for continued genre-level investment.")
